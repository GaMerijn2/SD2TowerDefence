...
public class Enemy : MonoBehaviour
{
    ...
    // Hello please note, i NEED this Enemy script in my enemy GameObject,
    // cause otherwise the tower won't target the enemy, im not in the mood to fix it as it is 23.55PM, Thank you :)
